...
1. **授权**
   ...
   1. <u>例外和限制</u> 为避免疑义，若著作权的例外和限制适用于您对授权作品(Licensed Material)的使用，本软件开源协议将不适用，您也无须遵守本软件开源协议之条款。
...
1. **其他权利**
   ...
   1. 在自愿的或可放弃的法定或强制许可机制下，许可人在范围内放弃对您因行使本协议所授予的权利而产生的使用费的权利，不论是直接收取或通过集体管理组织收取。在其他任何情况下（包括授权作品(Licensed Material)被大规模商业性使用的情形），许可人明确保留收取使用费的任何权利。
